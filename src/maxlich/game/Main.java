...
/*
ДОБАВИТЬ: уровни игры: этап 1, уровни с 1 по 10 - тупой комп (всё случайно выбирает), разные хп и дамаг у компа
                       этап 2, уровни с 1 по 10 - более умный комп (более умный выбор между атакой и движением и выбор местоположения игрока для атаки),
                                                 разные хп и дамаг у компа в зависимости от уровня
                       этап 3, уровни с 1 по 10 - либо суперумный компьтер, умный комп из этапа 2 но с читерством, хп и дамаг меняется от уровня к уровню
         героев для игрока (? нужно ли ?)

Игра "слепой бой". Похожа на морской бой, но здесь происходит схватка двух активных объектов (человека и монстра, человека и человек, т.д)
Одним из объектов управляет пользователь (игрок), вторый компьютер. Надо угадывать местонахождение противника. Угадав его местонахождение,
ты атакуешь его (и он получается определённый (случайный) урон). Победит тот, кто быстрее убьёт своего противника.
Начальная версия: объект может перемещаться вдоль одной линии.
Следующая версия: объект перемещается на плоскости. (два измерения
Максиммальная: у объекта есть силуэт и он перемещается по плоскости. У него есть голова, руки, ноги, пах, туловище. Всё, куда можно попасть.
Для каждой части тела свой урон. Можно ввести критический урон.
Возможные улучшения: -разные начальные герои для игрока, разные герои(существа) для противника (с разной силой, хп, скоростью перемещения);
                     -оружие и защита (доспехи и щиты)
                     -несколько противников или полный уклон в стратегию (возможность игроку управлять несколькими существами)
 */
